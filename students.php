...
<head>
    ...
    <title>Student Management | School Library</title>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <div class="search-add-bar">
                <div>
                    <input type="text" placeholder="Search students..." style="padding: 0.5rem; border: 1px solid #ddd; border-radius: 5px; width: 300px;">
                </div>
                <a href="add_student.php" class="btn-edit">
